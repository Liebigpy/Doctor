...
class MTM(nn.Module):
    ...
    def forward_loss(
        ...
        for key in targets.keys():
            ...
            #print("debug206",masked_c_loss,masked_c_loss.shape,key,mask)
            #print("debug207", masked_loss, masked_loss.shape)
    ...
    def mask_git_forward(self, trajectories, masks, temperature=1.0, ratio=1.0):
        ...
        """
        #print("debug406",masks,trajectories)
